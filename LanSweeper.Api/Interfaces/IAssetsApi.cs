...
public interface IAssetsApi
{
	...
	Task<IReadOnlyList<Asset>> GetBySiteAsync(string siteId, CancellationToken cancellationToken = default);
	...
	Task<Asset> GetByIdAsync(string assetId, CancellationToken cancellationToken = default);
}
